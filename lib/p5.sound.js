...
spatializer = function () {
  ...
  p5.Spatializer.prototype.orient = function (xVal, yVal, zVal, time) {
    ...
    return [
      this.spatializer.orientationX.value,
...
src_app = function () {
  var p5SOUND = sndcore;
  return p5SOUND;
}(sndcore, master, helpers, errorHandler, panner, soundfile, amplitude, fft, signal, oscillator, env, pulse, noise, audioin, filter, spatializer, listener3d, delay, reverb, metro, looper, compressor, soundRecorder, peakdetect, gain, distortion);
}));