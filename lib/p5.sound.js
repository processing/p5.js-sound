...
soundRecorder = function () {
  ...
  p5.SoundRecorder = function () {
    ...
    // stereo (default)
    this._leftBuffers = [];
    // array of arrays. Each is a Float32Array of BufferSize
    this._rightBuffers = [];
    this.recordedSamples = 0;
    this._jsNode = ac.createScriptProcessor(this.bufferSize, this.channels, 2);
