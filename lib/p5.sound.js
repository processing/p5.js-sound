/** [p5.sound]  Version: 1.0.1 - 2023-03-30 */ 
 /**
...
function panner_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { panner_typeof = function _typeof(obj) { return typeof obj; }; } else { panner_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return panner_typeof(obj); }
...
function _possibleConstructorReturn(self, call) { if (call && (panner_typeof(call) === "object" || typeof call === "function")) { return call; } return _assertThisInitialized(self); }
...
if (typeof panner_ac.createStereoPanner !== 'undefined') {
  ...
  function (_Effect) {
    ...
    function Panner() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Panner).call(this));
  ...
  function (_Effect2) {
    ...
    function _Panner() {
      ...
      _this2 = _possibleConstructorReturn(this, _getPrototypeOf(_Panner).call(this)); 
...
function oscillator_possibleConstructorReturn(self, call) { if (call && (oscillator_typeof(call) === "object" || typeof call === "function")) { return call; } return oscillator_assertThisInitialized(self); }
...
function oscillator_getPrototypeOf(o) { oscillator_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return oscillator_getPrototypeOf(o); }

function oscillator_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) oscillator_setPrototypeOf(subClass, superClass); }

function oscillator_setPrototypeOf(o, p) { oscillator_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return oscillator_setPrototypeOf(o, p); }
...
function (_Oscillator) {
  ...
  function SinOsc(freq) {
    ...
    return oscillator_possibleConstructorReturn(this, oscillator_getPrototypeOf(SinOsc).call(this, freq, 'sine'));
  }
...
function (_Oscillator2) {
  ...
  function TriOsc(freq) {
    ...
    return oscillator_possibleConstructorReturn(this, oscillator_getPrototypeOf(TriOsc).call(this, freq, 'triangle'));
  }
...
function (_Oscillator3) {
  ...
  function SawOsc(freq) {
    ...
    return oscillator_possibleConstructorReturn(this, oscillator_getPrototypeOf(SawOsc).call(this, freq, 'sawtooth'));
  }
...
function (_Oscillator4) {
  ...
  function SqrOsc(freq) {
    ...
    return oscillator_possibleConstructorReturn(this, oscillator_getPrototypeOf(SqrOsc).call(this, freq, 'square'));
  }
...
function envelope_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function envelope_createClass(Constructor, protoProps, staticProps) { if (protoProps) envelope_defineProperties(Constructor.prototype, protoProps); if (staticProps) envelope_defineProperties(Constructor, staticProps); return Constructor; }
...
function filter_get(target, property, receiver) { if (typeof Reflect !== "undefined" && Reflect.get) { filter_get = Reflect.get; } else { filter_get = function _get(target, property, receiver) { var base = filter_superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(receiver); } return desc.value; }; } return filter_get(target, property, receiver || target); }
...
function () {
 ...
 var gain = (gain_Gain);
function Env_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Env_typeof = function _typeof(obj) { return typeof obj; }; } else { Env_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Env_typeof(obj); }
...
function Env_possibleConstructorReturn(self, call) { if (call && (Env_typeof(call) === "object" || typeof call === "function")) { return call; } return Env_assertThisInitialized(self); }
...
function Env_getPrototypeOf(o) { Env_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Env_getPrototypeOf(o); }

function Env_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) Env_setPrototypeOf(subClass, superClass); }

function Env_setPrototypeOf(o, p) { Env_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Env_setPrototypeOf(o, p); }
...
function (_Envelope) {
  ...
  function Env(t1, l1, t2, l2, t3, l3) {
    ...
    return Env_possibleConstructorReturn(this, Env_getPrototypeOf(Env).call(this, t1, l1, t2, l2, t3, l3));
  }
