...
compressor = function () {
  ...
  */
  p5.Compressor.prototype.process = function (src, _attack, _knee, _ratio, _threshold, _release) {
    src.connect(this.input);
   ...
   *                            default = .25, range 0 - 1
   */
  p5.Compressor.prototype.set = function (_attack, _knee, _ratio, _threshold, _release) {
