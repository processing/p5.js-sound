...
panner3d = function () {
  ...
  p5.Panner3D.prototype.position = function (xVal, yVal, zVal, time) {
    ...
    return [
      this.spatialPanner.positionX.value,
  ...
  p5.Panner3D.prototype.orient = function (xVal, yVal, zVal, time) {
    ...
    return [
      this.spatialPanner.orientationX.value,
...
listener3d = function () {
  ...
  p5.Listener3D.prototype.position = function (xVal, yVal, zVal, timel) {
    ...
    return [
      this.spatialListener.positionX.value,
  ...
  p5.Listener3D.prototype.orient = function (xVal, yVal, zVal, time) {
    ...
    return [
      this.spatialListener.forwardX.value,
...
src_app = function () {
  var p5SOUND = sndcore;
  return p5SOUND;
}(sndcore, master, helpers, errorHandler, panner, soundfile, amplitude, fft, signal, oscillator, env, pulse, noise, audioin, filter, panner3d, listener3d, delay, reverb, metro, looper, compressor, soundRecorder, peakdetect, gain, distortion);
}));