...
soundfile = function () {
   ...
   *                                     of playback
   * @param {Number} [cueStart]        (optional) cue start time in seconds (0 = beginning of file)
   * @param {Number} [cueEnd]          (optional) cue end time in seconds (0 = beginning of file)
   */
   ...
   *
   * @method jump
   * @param {Number} cueTime    cueTime of the soundFile in seconds (0 = beginning of file).
   * @param {Number} endTime    endTime of the soundFile in seconds (0 = beginning of file).
   */
  p5.SoundFile.prototype.jump = function (cueTime, endTime) {
    ...
    this.play(now, this.playbackRate, this.output.gain.value, cTime, eTime);
  };
  /**
