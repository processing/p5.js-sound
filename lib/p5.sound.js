(function () {define('sndcore',['require'],function (require) {
  'use strict';
...
define('master',['require','sndcore'],function (require) {
...
define('helpers',['require','master'],function (require) {
...
define('soundfile',['require','sndcore','master'],function (require) {
...
define('amplitude',['require','master'],function (require) {
  'use strict';
  var p5sound = require('master');
...
define('fft',['require','master'],function (require) {
  'use strict';
...
define('oscillator',['require','master'],function (require) {
  'use strict';
...
define('pulse',['require','master','oscillator'],function (require) {
  'use strict';
...
define('lfo',['require','master','oscillator'],function (require) {
  'use strict';
...
define('noise',['require','master'],function (require) {
  'use strict';
...
define('audioin',['require','master'],function (require) {
  'use strict';
...
define('env',['require','master'],function (require) {
  'use strict';
...
define('src/app',['require','sndcore','master','helpers','soundfile','amplitude','fft','oscillator','pulse','lfo','noise','audioin','env'],function (require) {
