...
signal = function () {
  ...
  p5.SignalAdd = function (num) {
    ...
    // add.input = add.output = ac.createGain();
    // // add._value = new p5.Signal(num);
    // // add._value.connect(add.output);
    // // add.scalar.gain.value = num;
    // add.setInput = function(_input) {
    //   _input.output.connect(add.output);
    // };
    // // add.setValue = function(_val) {
    // //   add.setValue(_val);
    // // }
    // add.setValue(num);
    return add;
